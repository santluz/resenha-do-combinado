  ...
  return (
    <section id="sobre" className="bg-[#0D0D0D] py-20 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <blockquote className="text-[#C0C0C0] text-xl leading-relaxed font-light italic mb-8">"A Resenha do Combinado nasceu para registrar os bastidores, entrevistas e momentos especiais do futebol entre amigos."</blockquote>
