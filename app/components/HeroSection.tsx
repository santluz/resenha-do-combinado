  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0D0D0D]">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        {logoUrl && <div className="flex justify-center mb-6"><Image src={logoUrl} alt="Logo" width={100} height={100} className="rounded-full border-4 border-red-600 shadow-2xl object-cover" unoptimized /></div>}
