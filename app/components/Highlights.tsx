...
// Seção de melhores momentos / highlights — máx 3 vídeos
"use client";
    ...
    <section id="highlights" className="bg-[#111] py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          ...
          <span className="text-xs text-[#333] uppercase tracking-widest">{highlights.length} vídeo{highlights.length > 1 ? "s" : ""}</span>
        </div>
