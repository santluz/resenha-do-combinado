...
// Grade responsiva de entrevistas recentes
...
// Card individual de entrevista — reutilizável
function InterviewCard({ interview }: { interview: Interview }) {
  ...
  return (
    <article className="group bg-[#151515] border border-[#222] rounded-lg overflow-hidden hover:border-[#1A7A3A] transition-all duration-300 hover:shadow-lg hover:shadow-[#1A7A3A]/10 hover:-translate-y-1">
      ...
      {/* Info */}
      <div className="p-5">
        <p className="text-[#1A7A3A] text-xs font-bold uppercase tracking-widest mb-1">
          {interview.role}
        </p>
        ...
        <a
          ...
          aria-label={`Assistir entrevista com ${interview.name}`}
        >
  ...
  return (
    <section id="entrevistas" className="bg-[#0D0D0D] py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Grade responsiva: 1 col mobile → 2 tablet → 3 desktop */}
