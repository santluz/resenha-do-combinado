...
// Renomeado para "Última Entrevista"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          <div className="lg:col-span-3">
            <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-[#0D0D0D] border border-[#222] shadow-2xl shadow-red-600/10">
              {data.videoUrl ? (
                <video
                  src={data.videoUrl}
                  controls
