...
import { getLatestResenha, getInterviews, getHighlights, getGallery, getFeaturedPhoto, getNextMatch, getSiteConfig } from "@/lib/firestore";
...
export default async function Home() {
  const [resenha, interviews, highlights, gallery, featuredPhoto, nextMatch, siteConfig] = await Promise.all([
